...
hold off
xlabel('Value of $\lambda$ when $X_j$ enters model','FontName','Times New Roman','FontWeight','bold','FontSize',18);
ylabel('Value of $\lambda$ when $\tilde X_j$ enters model','FontName','Times New Roman','FontWeight','bold','FontSize',18);
limits = [0 ceil(max(Z))];
xlim(limits); ylim(limits);
%title('Knockoff Filter with Lasso','FontName','Times New Roman','FontWeight','bold','FontSize',18);
...
print('E:/Deep Learning/Research/Code/Matlab/mf_knockoffs/Figure/Final/F1_b.eps','-depsc2','-r1200');
%print -depsc 'E:/Deep Learning/Research/Code/Matlab/mf_knockoffs/Figure/Final/F1_b.eps'
%saveas(fig,'E:/Deep Learning/Research/Code/Matlab/mf_knockoffs/Figure/Final/F1_b.eps','epsc');
