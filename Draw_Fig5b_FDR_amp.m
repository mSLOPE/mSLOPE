...
formatSpec = '%f';
Y = fscanf(fopen(strcat(prefix_cache,'FDR_Rib_SLOPE_MFKnockoff_amp.txt'),'r'),formatSpec);
Y2 = fscanf(fopen(strcat(prefix_cache,'FDR_Rib_LCD_Knockoff_amp.txt'),'r'),formatSpec);
Y3 = fscanf(fopen(strcat(prefix_cache,'FDR_Rib_LSM_Knockoff_amp.txt'),'r'),formatSpec);
Y4 = fscanf(fopen(strcat(prefix_cache,'FDR_Rib_BHq_amp.txt'),'r'),formatSpec);
X = [9 12 15 18 21];
...
%xlim(xlimits);
ylim([0 4.5]); %increase y Limit to 4.5 for displaying legend
set(gca,'XTick',(9:3:21));
set(gca,'YTick',(0:1.0:4.5));
legend('mSLOPE','LCD', 'LSM','BHq','Orientation','horizontal');
%title('Example: Real Data Riboflavin');
set(gca,'FontName','Times New Roman','Fontsize',18);
print('E:/Deep Learning/Research/Code/Matlab/mf_knockoffs/Figure/Final/Fig4a_FDR_amp.eps','-depsc2','-r1200');